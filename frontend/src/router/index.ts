...
const routes: RouteRecordRaw[] = [
...

  {
    ...
    children: [
      { path: 'dashboard', component: () => import('@/views/user/Dashboard.vue'), meta: { title: '我的首页' } },
      { path: 'profile', component: () => import('@/views/user/Profile.vue'), meta: { title: '个人信息' } },
      { path: 'attendance', component: () => import('@/views/user/Attendance.vue'), meta: { title: '我的考勤' } },
      { path: 'leave', component: () => import('@/views/user/Leave.vue'), meta: { title: '我的请假' } },
      { path: 'salary', component: () => import('@/views/user/Salary.vue'), meta: { title: '我的工资' } },
      { path: 'performance', component: () => import('@/views/user/Performance.vue'), meta: { title: '我的绩效' } },
      { path: 'training', component: () => import('@/views/user/Training.vue'), meta: { title: '我的培训' } },
      { path: 'contract', component: () => import('@/views/user/Contract.vue'), meta: { title: '我的合同' } },
    ],
  },
]
